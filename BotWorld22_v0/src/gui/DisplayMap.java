...
{
    private HashMap<String, Display> map = new HashMap<String, Display>();
...
//            System.out.println(">>> "+cl.toString());
            String className = cl.toString().replace("class ","");
...
//            System.out.println("Exception#2");
    ...
    public Display findDisplayFor(Class cl)
    {
        ...
        Display display = map.get(cl.toString());
        if (display != null)
            return display;
