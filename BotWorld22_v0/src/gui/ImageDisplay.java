...
public class ImageDisplay extends AbstractDisplay
{
    ...
    {
        this.cl = cl;
        imageFilename = cl.getName().replace(".", "/images/");
...
//        System.out.println("URL>" +url);
     ...
     * @param imageFilename name of file containing image
     */
    public ImageDisplay(String imageFilename) throws IOException
    {
...
//            if(obj instanceof BotBrain)
//            {
//                color = (Color) getProperty(obj, "preferredColor");
//            }
//            if (obj instanceof BotBrain)
//            {
